...
<template>
  <td>
    <Array v-if="schema.type == 'Array'" ctx='table' :value="value" />
    <BooleanField v-if="schema.type == 'Boolean'" ctx='table' :value="value" />
    <DateField v-if="schema.type == 'Date'" ctx='table' :value="value" />
